...
// NOTE: NUM_PAD numbers are only sent when num lock is on.  Otherwise the num pad acts as Home/Up Arrow/PgUp/etc etc
        'KEY_NUM_PAD_0': {'default': '0', 'appmode': ESC+"Op"},
        'KEY_NUM_PAD_1': {'default': '1', 'appmode': ESC+"Oq"},
        'KEY_NUM_PAD_2': {'default': '2', 'appmode': ESC+"Or"},
        'KEY_NUM_PAD_3': {'default': '3', 'appmode': ESC+"Os"},
        'KEY_NUM_PAD_4': {'default': '4', 'appmode': ESC+"Ot"},
        'KEY_NUM_PAD_5': {'default': '5', 'appmode': ESC+"Ou"},
        'KEY_NUM_PAD_6': {'default': '6', 'appmode': ESC+"Ov"},
        'KEY_NUM_PAD_7': {'default': '7', 'appmode': ESC+"Ow"},
        'KEY_NUM_PAD_8': {'default': '8', 'appmode': ESC+"Ox"},
        'KEY_NUM_PAD_9': {'default': '9', 'appmode': ESC+"Oy"},
